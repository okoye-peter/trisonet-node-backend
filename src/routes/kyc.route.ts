...
import { uploadKyc, faceVerification, updateUserBvnHash, ninVerification } from "../controllers/kyc.controller";
...
router.post("/nin-verify", upload.fields([{ name: 'image', maxCount: 1 }]), ninVerification);
